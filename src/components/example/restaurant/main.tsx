...
import demo from "@/assets/thetokyoTimePopUp.png";
...
// hoặc chỉnh lại tùy theo vị trí thực tế file
  ...
  const animatedArrowColorStyle = useAnimatedStyle(() => {
    return {
      color: interpolateColor(
        scrollY.value,
        [0, 100],
        ["white", APP_COLOR.GRAY] // Arrow color range
      ),
    };
  });
          ...
          >
            ...
            >
              <Text
                style={{
                  color:
                    item.index === activeMenuIndex ? APP_COLOR.GRAY : "black",
                  marginHorizontal: 5,
                }}
              >
                {item.title}
